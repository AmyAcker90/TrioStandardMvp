...
public class IViewHolder extends RecyclerView.ViewHolder {
    ...
    public IViewHolder(Context context, View itemView) {
        super(itemView);
        mContext = context;
    ...
    public static IViewHolder createViewHolder(Context context, View itemView) {
        IViewHolder holder = new IViewHolder(context, itemView);
        return holder;
    }

    public static IViewHolder createViewHolder(Context context,
    ...
    public IViewHolder setImageResource(int viewId, int resId) {
    ...
    public IViewHolder setImageUrl(int viewId, String url) {
        ImageView view = getView(viewId);
        ImageUtil.getInstance(mContext).load(url, view);
        return this;
    }
     ...
     * 关于事件的
     */
    public IViewHolder setOnClickListener(int viewId,
    ...
    public IViewHolder setOnTouchListener(int viewId,
    ...
    public IViewHolder setOnLongClickListener(int viewId,
